	...
	<div class="col">
		<div class="card">
			<div class="card-header">
				<h4 class="card-tite mb-0">Tambah data Mahasiswa</h4>
			</div>
			<div class="card-body">
				<form action="<?=site_url('admin/data/mahasiswa/tambah/submit')?>" method='post'>
					...
					<div class="form-row">
						<div class="col">
							<input type="submit" name="submit" class="btn btn-success btn-block"				</div>
					</div>
				</form>
			</div>
		</div>
