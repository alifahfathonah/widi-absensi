	...
	<div class="col">
		<div class="card">
			<div class="card-header">
				<h4 class="card-tite mb-0">Edit data Kelas</h4>
			</div>
			<div class="card-body">
				<form action="<?=site_url('admin/data/kelas/edit/submit')?>" method='post'>
					...
					<div class="form-row mb-4">
						<div class="col">
							...
							<div class="input-group">
								...
								<?php 
									echo form_dropdown('dosen_pengajar_id', $dosen_options, $kelas->dosen_pengajar_id, array('class' => 'form-control'));
								?>
							</div>
						</div>
						<div class="col">
							...
							<div class="input-group">
								...
								<?php 
									echo form_dropdown('mata_kuliah_id', $mata_kuliah_options, $kelas->mata_kuliah_id, array('class' => 'form-control'));
								?>
							</div>
						</div>
						<div class="col">
							...
							<div class="input-group">
								...
								<?php 
									echo form_dropdown('program_studi_id', $prodi_options, $kelas->program_studi_id, array('class' => 'form-control', 'readonly' => 'readonly'));
								?>
							</div>
						</div>
					</div>
						...
						<div class="col">
							...
							<div class="input-group">
								...
								<?php 
									...
									echo form_dropdown('hari', $hari_options, $kelas->hari, array('class' => 'form-control'));
								?>
							</div>
						</div>
						<div class="col">
							...
							<div class="input-group">
								...
								<input type="time" name="waktu" value="<?=$kelas->waktu?>" class="form-control">
							</div>
						</div>
					</div>
					<div class="form-row mb-4">
						<div class="col">
							...
							<div class="input-group">
								...
								<input type="text" name="semester" value="<?=$kelas->semester?>" class="form-control">
							</div>
						</div>
						<div class="col">
							...
							<div class="input-group">
								...
								<?php 
									...
									echo form_dropdown('status_kelas', $status_options, $kelas->status_kelas, array('class'=> 'form-control'));
								?>
							</div>
						</div>
					</div>
